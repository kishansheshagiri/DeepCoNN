...
import os
import pickle
tf.flags.DEFINE_string("valid_data","../data/yelp/penn/yelp_valid.csv", " Data for validation")
tf.flags.DEFINE_string("test_data", "../data/yelp/penn/yelp_test.csv", "Data for testing")
tf.flags.DEFINE_string("train_data", "../data/yelp/penn/yelp_train.csv", "Data for training")
tf.flags.DEFINE_string("user_review", "../data/yelp/penn/user_review", "User's reviews")
tf.flags.DEFINE_string("item_review", "../data/yelp/penn/item_review", "Item's reviews")
...
if __name__ == '__main__':
    ...
    output = open(os.path.join(TPS_DIR, 'yelp.train'), 'wb')
    pickle.dump(batches_train,output)
    output = open(os.path.join(TPS_DIR, 'yelp.test'), 'wb')
    ...
    para['u_text'] = u_text
    para['i_text'] = i_text
    output = open(os.path.join(TPS_DIR, 'yelp.para'), 'wb')
